...
ap.add_argument("-p", "--prototxt", default="model/MobileNetSSD_deploy.prototxt.txt",
    help="path to Caffe 'deploy' prototxt file")
ap.add_argument("-m", "--model", default="model/MobileNetSSD_deploy.caffemodel",
...
ClassesRequired=["bus","bicycle","motobike"]
    ...
    for i in np.arange(0, detections.shape[2]):
        ...
        if confidence > args["confidence"]:
            ...
            if tag=="car":
                ...
                for classname in ClassesRequired:
                    if(tag==classname):        
